...
3. 填寫儲存庫資訊:
   - **Repository name**: `ibuzz-editor` (或你喜歡的名稱)
...
git remote add origin https://github.com/your-username/ibuzz-editor.git
...
2. 在 GitHub 提交 [Issue](https://github.com/your-username/ibuzz-editor/issues)
3. 聯絡開發團隊
